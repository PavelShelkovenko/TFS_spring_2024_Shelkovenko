package com.pavelshelkovenko.tfs_spring_2024_shelkovenko.homework_3
...
import com.pavelshelkovenko.tfs_spring_2024_shelkovenko.chat_adapters.date.DateDelegateItem
import com.pavelshelkovenko.tfs_spring_2024_shelkovenko.chat_adapters.date.DateModel
...
import com.pavelshelkovenko.tfs_spring_2024_shelkovenko.chat_adapters.message.received_message.ReceivedMessageDelegateItem
import com.pavelshelkovenko.tfs_spring_2024_shelkovenko.chat_adapters.message.received_message.ReceivedMessageModel
import com.pavelshelkovenko.tfs_spring_2024_shelkovenko.chat_adapters.message.send_message.SendMessageDelegateItem
import com.pavelshelkovenko.tfs_spring_2024_shelkovenko.chat_adapters.message.send_message.SendMessageModel
...
class TestViewModel(
    ...
    private val _isMessageTextFieldEmpty = MutableStateFlow(true)
    val isMessageTextFieldEmpty: StateFlow<Boolean>
        get() = _isMessageTextFieldEmpty
    ...
    private fun setupList() {
        ...
        val dateInfo = DateDelegateItem(
            id = 1,
            value = DateModel("1 February")
        )
    ...
    fun processMessageFieldChanges(newMessage: String) {
        ...
        _isMessageTextFieldEmpty.value = _messageToSend.value.isBlank()
    }
